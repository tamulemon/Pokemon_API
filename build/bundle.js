...
React.render(React.createElement(App, {appName: "PokemonAPI"}), document.body);		

},{"./header.jsx":2,"./pokemon2.jsx":5,"react":161}],2:[function(require,module,exports){
var React = require('react');
...
var Header = module.exports = React.createClass({displayName: "exports",
	render: function() {
		return (
			React.createElement("h1", null, "Pokemon API")
		)
	}
});
...
var PokeImage = module.exports = React.createClass({displayName: "exports",
	
		getImgUri: function() {
			console.log('sprites on image tag', this.props.pokemonSprites);
			$.ajax({
				url: (this.props.pokemon.sprites)[0].resource_uri,
				dataType: 'json',
				type: 'GET',
				cache: true,
				success: function(spriteData) {
					...
					this.setState ({
						uri: this.state.uri = 'http://pokeapi.co/' + spriteData.image
					});
				}.bind(this),
	...
	render: function() {
		return (
			React.createElement("img", {src: this.state.uri})
		)
	}
	
});

},{"jquery":162,"react":161}],4:[function(require,module,exports){
var React = require('react');
var $ = require('jquery');

var PokeImage = require('./images.jsx');


var Pokemon = module.exports = React.createClass({displayName: "exports",
	
	loadARandomPokemon: function() {
//		function randomrize() {};
...
//				console.log(data.name);
				this.setState ({
					pokemon: this.state.pokemon = data // because dataType is set to 'json', don't need to JSON.parse here. data is already a JS object
				});
			}.bind(this),
			error: function(xhr, status, err) {
				console.error(status, err.toString());
	...
	render: function() {
		...
		if (this.state.pokemon === {}) {
			...
			React.createElement("div", null, 
				React.createElement("h2", null, this.state.pokemon.name), 
				React.createElement("p", null, this.state.pokemon.hp), 
				React.createElement(PokeImage, {pokemonSprites: this.state.pokemon.sprites})
			)
		)
	}
});

},{"./images.jsx":3,"jquery":162,"react":161}],5:[function(require,module,exports){
var React = require('react');
var $ = require('jquery');
...
var Pokemon = module.exports = React.createClass({displayName: "exports",
	...
	render: function() {
		...
		return (
			...
			React.createElement("h2", null, this.state.pokemon.name), 
				React.createElement("p", null, this.state.pokemon.hp), 
			React.createElement("img", {src: this.state.pokemon.imgUri, alt: "pokemon image", height: "150", width: "150"}), 
			React.createElement("button", {onClick: this.randomrize}, "Randomrize Pokemon")
			)
		)
	}
});

},{"jquery":162,"react":161}],6:[function(require,module,exports){
